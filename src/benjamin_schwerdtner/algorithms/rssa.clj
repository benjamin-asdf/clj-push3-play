(ns benjamin-schwerdtner.algorithms.rssa)
...
(defn synergy [entity-a entity-b context {:keys [fitness compose]}]
  (-
   (fitness-δ (compose entity-a entity-b) context)
   ...
   (fitness-δ entity-a context)
   (fitness-δ entity-b context)))
...
#_(defn reciprocal-synergy-symbiosis
    "
